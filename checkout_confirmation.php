...
<?php
  ...
  for ($i=0, $n=sizeof($order->products); $i<$n; $i++) {
    echo '          <tr>' . "\n" .
         ...
         '            <td valign="top">' . stripslashes($order->products[$i]['name']);
    ...
    if ( (isset($order->products[$i]['attributes'])) && (sizeof($order->products[$i]['attributes']) > 0) ) {
	  ...
	  //BOF - Zappo - Option Types v2 - Removed <nobr>, because Text options can be very long and added Attribute prices
        ...
        echo '</small>';
//EOF - Zappo - Option Types v2 - Removed <nobr>, because Text options can be very long and added Attribute prices
...
jQuery('#coProgressBar').progressbar({
  value: 100
});
</script>
