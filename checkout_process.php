...
//BOF - Zappo - Option Types v2 - ONE LINE - Update insert query.  changed to use value from $order->products.
		...
		//BOF - Zappo - Option Types v2 - ONE LINE - Changed to use value from $orders->products and added call to tep_decode_specialchars()
...
//------insert customer choosen option eof ----
  ...
  //if (MODULE_ORDER_TOTAL_DISCOUNT_STATUS == 'true' && !empty($discount)) {
	...
	if (MODULE_ORDER_TOTAL_DISCOUNT_STATUS == 'true' && !empty($_SESSION['sess_discount_code'])) {
