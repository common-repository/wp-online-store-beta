...
if (isset($_SESSION['comments']) && tep_not_null($_SESSION['comments'])) {
	$comments = tep_db_prepare_input($_SESSION['comments']);
  }
...
<?php
if (isset($HTTP_GET_VARS['payment_error']) && is_object($GLOBALS[$HTTP_GET_VARS['payment_error']]) && ($error = $GLOBALS[$HTTP_GET_VARS['payment_error']]->get_error())) {
...
?>
  ...
  <div class="contentText">
    ...
    <div class="ui-widget infoBoxContainer" style="float: right; width:35%">
