...
$attributes = tep_db_fetch_array($attributes_query);
		//BOF - Zappo - Option Types v2 - Determine if attribute is a text attribute and change products array if it is.
            ...
            $this->products[$index]['attributes'][$subindex] = array('option' => $attributes['products_options_name'],
                                                                     'value' => $attr_value,   // changed to use $attr_value
                                                                     'option_id' => $option,
                                                                     'value_id' => $value,
                                                                     'prefix' => $attributes['price_prefix'],
                                                                     'price' => $attributes['options_values_price']);
//EOF - Zappo - Option Types v2 - Determine if attribute is a text attribute and change products array if it is.
