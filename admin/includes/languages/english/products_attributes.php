...
define('HELP_VIDEO','');
define('HELP_TEXT','This area of the catalog configuration is where you customize the attributes of your products. If you need to have different sizes, options, colors, and have different prices for each option, you have the ability to set this here. When you first look at this section section, it can look a bit complicated. The base WP Online Store installation includes sample data, including pre set attributes. You should study how these attributes are constructed. Then, it is suggested that you create a sample product, and your own attributes to see how the different options function. Detailed information is available in our knowledgebase under Products and Categories > Setting Up Product Attributes.');
?>