...
define('TEXT_CATEGORIES_DESC', 'Category Description:');
...
define('TEXT_PRODUCTS_MAIN_IMAGE', 'Add Thumbnail/Small Image');
define('TEXT_PRODUCTS_LARGE_IMAGE', 'Main Product Image');
define('TEXT_PRODUCTS_LARGE_IMAGE_HTML_CONTENT', 'HTML Content (for popup)');
define('TEXT_PRODUCTS_ADD_LARGE_IMAGE', 'Add Main Product Image/s');
...
define('HELP_VIDEO','');
define('HELP_TEXT','This is where you can add your categories and products to the catalog. There are several things you can do, but first, you need to create a category. In the middle window of the page, you will see a folder listing. Each folder is a category. These folders are clickable, so that you can navigate into the categories, to see products in those categories and possible subcategories. For more information look in our knowledgebase under Products and Categories - Getting Started.');
...
define('TEXT_PRODUCTS_SEO_URL','Product SEO URL');
/*** End Header Tags SEO ***/
// BOF Minimum Category Tree Quantity
	define('TEXT_CAT_TREE_MIN_QUAN','Category and Subcategories Minimum Order');
