...
// configuration box text in includes/boxes/quick_setup.php
define('BOX_HEADING_QUICK_SETUP', 'QUICK START');



// configuration box text in includes/boxes/configuration.php
define('BOX_HEADING_CONFIGURATION', 'STORE SETTINGS');
define('BOX_CONFIGURATION_MYSTORE', 'My Store Settings');
...
define('BOX_HEADING_CATALOG', 'PRODUCTS');
...
define('BOX_CATALOG_SPECIALS', 'Specials / Sale Items');
...
define('BOX_TOOLS_ACTION_RECORDER', 'Action Recorder Logs');
define('BOX_TOOLS_BACKUP', 'Database Backup');
define('BOX_TOOLS_BANNER_MANAGER', 'Banner Ad Manager');
define('BOX_TOOLS_CSS_EDITOR', 'Stylesheet editor');
define('BOX_TOOLS_CACHE', 'Cache Control');
define('BOX_TOOLS_DEFINE_LANGUAGE', 'Define Languages / Edit Pages');
define('BOX_TOOLS_MAIL', 'Send Mass Email');
...
// tools text in includes/boxes/advanced.php
define('BOX_HEADING_ADVANCED', 'ADVANCED');
...
// google translator 
define('BOX_GOOGLE_TRANSLATOR', 'Google Translator');
...
define('IMAGE_ORDERS_EDIT', 'Order Edit');
...
define('IMAGE_MODULE_INSTALL', 'Install Additional Modules');
...
//define('TEXT_INSTALL_GOLD_STORE', 'To add additional payment gateways <a href="http://wponlinestore.com/" target="__balnk">Click Here>></a>');
define('TEXT_INSTALL_GOLD_STORE','<a href="http://www.wponlinestore.com/store/order/index.php?task=cart&category_id=3.3" target="__balnk">'.tep_image(DIR_WS_IMAGES . 'payments.png').'</a>');
define('TEXT_INSTALL_WP_SHIPPING','<a href="http://www.wponlinestore.com/store/order/index.php?task=cart&category_id=3.3" target="__balnk">'.tep_image(DIR_WS_IMAGES . 'payments.png').'</a>');
...
define('TEXT_DISPLAY_NUMBER_OF_DISCOUNT_CODES', 'Displaying <b>%d</b> to <b>%d</b> (of <b>%d</b>
discount codes)');
define('IMAGE_NEW_DISCOUNT_CODE', 'New Discount Code');
// Discount Code 2.6 - end

//slide show
define('BOX_CATALOG_SLIDESHOW', 'Home Page Slideshow');
define('TEXT_DISPLAY_NUMBER_OF_SLIDES', 'Displaying <b>%d</b> to <b>%d</b> (of <b>%d</b> slides)');


// Help section
define('TEXT_HELP_INSTURCTIONS','&nbsp;&nbsp;<a href="help.wponlinestore.com"  rel="http://www.wponlinestore.com" target="__balnk" title="Help" class="text_tips">'.tep_image(DIR_WS_IMAGES . 'tutorial.png','','30px','30px','align="absmiddle"').'</a>');
define('TEXT_HELP_VIDEO','&nbsp;&nbsp;<a href="" rel="http://www.wponlinestore.com" target="__balnk" class="tips" title="Video Tutorial">'.tep_image(DIR_WS_IMAGES . 'vtutorial.png','','30px','30px','align="absmiddle"').'</a>');
...
//format default products
define('BOX_FORMAT', 'Delete Demo Products');
?>
