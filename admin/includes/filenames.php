...
// define the filenames used in the project
  ...
  define('FILENAME_CSS_EDITOR', 'CSS-Editor.php');


  define('FILENAME_SLIDESHOW', 'slideshow.php');


  define('FILENAME_GOOGLE_TRANSLATOR', 'google_translator.php');
...
define('FILENAME_DISCOUNT_CODES', 'discount_codes.php'); // Discount Code 2.6   
  ...
  //for fomat default products 


  define('FILENAME_FORMAT', 'format.php');
...
// order editor
 ...
 define('FILENAME_ORDERS_EDIT_AJAX', HTTP_SERVER.DIR_WS_CATALOG.'admin/edit_orders_ajax.php');
 define('FILENAME_ACCOUNT_HISTORY_INFO', 'account_history_info.php');

   // end order editor
// BOF Product Sort
  define('FILENAME_PRODUCTS_SORTER', 'products_sorter.php');
// EOF Product Sort
